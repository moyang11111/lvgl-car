 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font C:/Users/ASUS/Desktop/lvgl/assets/STFANGSO.TTF -o C:/Users/ASUS/Desktop/lvgl/assets\ui_font_Font1.c --format lvgl -r 0x20-0x7f --symbols 账户密码登录用户注册你好 --no-compress --no-prefilter
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+518C "册" */
    0x0, 0x20, 0x73, 0x81, 0x4a, 0x5, 0x28, 0x14,
    0xa0, 0x52, 0xa3, 0xff, 0x39, 0x28, 0x24, 0xa0,
    0x92, 0x84, 0x52, 0x11, 0x48, 0x86, 0x20, 0x10,
    0x80,
    ...
    /* U+5F55 "录" */
    0x0, 0x40, 0x7f, 0x0, 0x4, 0x3, 0xe0, 0x0,
    0xb1, 0xff, 0xe7, 0x20, 0x8, 0x88, 0x13, 0x40,
    0x2a, 0x1, 0x24, 0x18, 0x88, 0x82, 0x18, 0x18,
    0x0, 0x20, 0x0,
    ...
    /* U+6CE8 "注" */
    0x0, 0x0, 0x6, 0x2, 0x8, 0x4, 0x4, 0x7,
    0xe2, 0x22, 0x5, 0x8, 0x4, 0x2c, 0x17, 0xc0,
    0x42, 0x2, 0x8, 0x8, 0x20, 0x60, 0xbc, 0x3d,
    0x0,
    ...
    /* U+767B "登" */
    0x1, 0x20, 0xf3, 0x0, 0x49, 0xa, 0x18, 0x11,
    0xc0, 0xb8, 0x84, 0x1d, 0x83, 0x90, 0x8, 0x80,
    0x3e, 0x0, 0x8, 0x1, 0x40, 0x3f, 0xf8,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 926, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 951, .adv_w = 256, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 980, .adv_w = 256, .box_w = 11, .box_h = 14, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 1000, .adv_w = 256, .box_w = 14, .box_h = 15, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1027, .adv_w = 256, .box_w = 11, .box_h = 15, .ofs_x = 2, .ofs_y = -3},
    {.bitmap_index = 1048, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 1073, .adv_w = 256, .box_w = 13, .box_h = 14, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1096, .adv_w = 256, .box_w = 14, .box_h = 13, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 1119, .adv_w = 256, .box_w = 13, .box_h = 14, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1142, .adv_w = 256, .box_w = 15, .box_h = 14, .ofs_x = 1, .ofs_y = -2}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x22c, 0xa1d, 0xc66, 0xff5, 0x12d7, 0x1d88, 0x25c8,
    0x271b, 0x28a1, 0x3dc6
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 20320, .range_length = 15815, .glyph_id_start = 97,
